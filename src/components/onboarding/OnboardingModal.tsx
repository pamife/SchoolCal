...
export const OnboardingModal: React.FC<OnboardingModalProps> = ({
  ...
  return (
    <div className="visual-viewport-overlay fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 pt-[max(1rem,env(safe-area-inset-top,0px))] pb-[max(1rem,env(safe-area-inset-bottom,0px))] pl-[max(0.75rem,env(safe-area-inset-left,0px))] pr-[max(0.75rem,env(safe-area-inset-right,0px))] overflow-y-auto">
      {/* Backdrop */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
