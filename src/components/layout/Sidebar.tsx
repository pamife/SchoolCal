...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="hidden ipad:flex flex-col w-64 xl:w-72 bg-gray-50/80 dark:bg-ios-dark-card/90 backdrop-blur-xl border-r border-black/5 dark:border-white/10 shrink-0 h-full overflow-y-auto overscroll-contain no-scrollbar pt-safe pb-safe px-4 select-none">
      {/* Brand Header */}
