...
import { Search, Plus, MapPin, CalendarDays, Sparkles } from 'lucide-react';
...
export const TopHeader: React.FC<TopHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 ios-glass-bar border-b border-black/5 dark:border-white/10 pt-safe px-4 py-2.5">
