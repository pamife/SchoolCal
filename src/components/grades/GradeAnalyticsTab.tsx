...
import { Award, Plus, TrendingUp, BarChart3, Trash2, BookOpen, Star, Sparkles } from 'lucide-react';
...
export const GradeAnalyticsTab: React.FC<GradeAnalyticsTabProps> = ({
  onOpenPricing,
  onOpenActivation,
}) => {
      ...
      <div className="space-y-6">
        ...
        {subjects.length === 0 ? (
          <div className="ios-card p-8 text-center text-xs text-gray-400">
            Lege zuerst deine Schulfächer an, um Noten einzutragen.
          </div>
        ) : (
